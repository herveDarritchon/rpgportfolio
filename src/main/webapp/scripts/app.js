...
var rpgPortfolioApp = angular.module('rpgPortfolioApp', ['http-auth-interceptor', 'tmh.dynamicLocale',
    'ngResource', 'ngRoute', 'ngCookies', 'rpgPortfolioAppUtils', 'pascalprecht.translate', 'truncate']);
