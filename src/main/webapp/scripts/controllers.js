...
rpgPortfolioApp.controller('MainController', function ($scope) {
    });

rpgPortfolioApp.controller('AdminController', function ($scope) {
    });

rpgPortfolioApp.controller('LanguageController', function ($scope, $translate, LanguageService) {
...
rpgPortfolioApp.controller('MenuController', function ($scope) {
    });

rpgPortfolioApp.controller('LoginController', function ($scope, $location, AuthenticationSharedService) {
...
rpgPortfolioApp.controller('LogoutController', function ($location, AuthenticationSharedService) {
        AuthenticationSharedService.logout();
    });

rpgPortfolioApp.controller('SettingsController', function ($scope, Account) {
        $scope.success = null;
        $scope.error = null;
...
rpgPortfolioApp.controller('RegisterController', function ($scope, $translate, Register) {
        $scope.success = null;
        $scope.error = null;
...
rpgPortfolioApp.controller('ActivationController', function ($scope, $routeParams, Activate) {
...
rpgPortfolioApp.controller('PasswordController', function ($scope, Password) {
        $scope.success = null;
        $scope.error = null;
        $scope.doNotMatch = null;
...
rpgPortfolioApp.controller('SessionsController', function ($scope, resolvedSessions, Sessions) {
        $scope.success = null;
        $scope.error = null;
 ...
 rpgPortfolioApp.controller('TrackerController', function ($scope) {
...
rpgPortfolioApp.controller('MetricsController', function ($scope, MetricsService, HealthCheckService, ThreadDumpService) {
...
rpgPortfolioApp.controller('LogsController', function ($scope, resolvedLogs, LogsService) {
...
rpgPortfolioApp.controller('AuditsController', function ($scope, $translate, $filter, AuditsService) {
