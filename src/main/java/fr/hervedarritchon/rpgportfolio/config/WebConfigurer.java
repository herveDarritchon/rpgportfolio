package fr.hervedarritchon.rpgportfolio.config;

import com.codahale.metrics.MetricRegistry;
import com.codahale.metrics.servlet.InstrumentedFilter;
import com.codahale.metrics.servlets.MetricsServlet;
import fr.hervedarritchon.rpgportfolio.web.filter.CachingHttpHeadersFilter;
import fr.hervedarritchon.rpgportfolio.web.filter.StaticResourcesProductionFilter;
import fr.hervedarritchon.rpgportfolio.web.filter.gzip.GZipServletFilter;
...
public class WebConfigurer implements ServletContextInitializer {
    ...
    private void initAtmosphereServlet(ServletContext servletContext) {
        ...
        atmosphereServlet.setInitParameter("org.atmosphere.cpr.packages", "fr.hervedarritchon.rpgportfolio.web.websocket");
